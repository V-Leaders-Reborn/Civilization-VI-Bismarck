...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="D:\Civ6Mod\gitproject\Civ5_Leaders_Reborn\Civ5_Leaders_Reborn\Texture_Source\Bismarck\bismarck_hair_diff.png"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>743585207</m_ExportedTime>
	<m_ClassName text="Leader_BaseColor"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="bismarck_hair_diff.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="bismarck_hair_diff"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
