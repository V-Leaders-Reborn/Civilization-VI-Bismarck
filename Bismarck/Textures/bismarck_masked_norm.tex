...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/Bismarck\Textures\bismarck_masked_norm.DDS"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>159329432</m_ExportedTime>
	<m_ClassName text="Leader_Normal"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="bismarck_masked_norm.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="bismarck_masked_norm"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
