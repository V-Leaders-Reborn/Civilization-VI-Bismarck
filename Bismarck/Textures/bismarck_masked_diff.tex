...
<AssetObjects..TextureInstance>
	...
	<m_SourceFilePath text="//civ6/main/Bismarck\Textures\bismarck_masked_diff.DDS"/>
	<m_SourceObjectName text=""/>
	<m_ImportedTime>0</m_ImportedTime>
	<m_ExportedTime>159409066</m_ExportedTime>
	<m_ClassName text="Leader_BaseColor"/>
	<m_DataFiles>
		<Element>
			<m_ID text="DDS"/>
			<m_RelativePath text="bismarck_masked_diff.dds"/>
		</Element>
	</m_DataFiles>
	<m_Name text="bismarck_masked_diff"/>
	<m_Description text=""/>
	<m_Tags/>
</AssetObjects..TextureInstance>
